...
namespace Szertar.Dal.Migrations
{
    ...
    [Migration("20190527205848_OrderUpdate_UserId")]
    partial class OrderUpdate_UserId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Szertar.Dal.Entities.Cart", b =>
                {
            ...
            modelBuilder.Entity("Szertar.Dal.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Szertar.Dal.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Szertar.Dal.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Szertar.Dal.Entities.Cart", b =>
                {
                    b.HasOne("Szertar.Dal.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne("Cart")
                        .HasForeignKey("Szertar.Dal.Entities.Cart", "ApplicationUserId");
                });
